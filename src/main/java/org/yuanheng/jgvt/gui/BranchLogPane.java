 ...
 * @author	Heng Yuan
 */
class BranchLogPane extends JPanel
{
	private static final long serialVersionUID = -7884379989195995631L;
		...
		public void mouseClicked (MouseEvent e)
		{
			if (e.getClickCount () >= 2)
			{
				...
				if (row != -1)
				{
					...
					BranchLogModel model = (BranchLogModel) m_table.getModel ();
	...
	public BranchLogPane (Controller controller, BranchLog log)
	{
		...
		m_table = new JTable (new BranchLogModel (log));
